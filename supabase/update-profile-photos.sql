...
WHERE user_id = get_demo_user_id('sophie.laurent@demo.easyco.com');
...
WHERE user_id = get_demo_user_id('ahmed.elmansouri@demo.easyco.com');
...
WHERE user_id = get_demo_user_id('emma.vanderberg@demo.easyco.com');
...
WHERE user_id = get_demo_user_id('lucas.dubois@demo.easyco.com');
...
WHERE user_id = get_demo_user_id('maria.santos@demo.easyco.com');
...
WHERE user_id = get_demo_user_id('jeanmarc.petit@demo.easyco.com');
...
WHERE user_id = get_demo_user_id('isabelle.moreau@demo.easyco.com');
...
WHERE user_id = get_demo_user_id('thomas.janssens@demo.easyco.com');
...
WHERE user_id = get_demo_user_id('sophie.vermeulen@demo.easyco.com');
...
WHERE user_id = get_demo_user_id('pierre.lecomte@demo.easyco.com');
...
WHERE user_id = get_demo_user_id('laura.gonzalez@demo.easyco.com');
...
WHERE user_id = get_demo_user_id('maxime.dubois@demo.easyco.com');

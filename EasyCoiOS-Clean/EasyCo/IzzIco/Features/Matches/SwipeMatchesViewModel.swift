...
class SwipeMatchesViewModel: ObservableObject {
    ...
    func loadProperties() async {
        ...
        do {
            ...
            let matchedProperties = try await apiClient.getMatches(filters: propertyFilters)
    ...
    private func likeProperty(_ property: Property) async {
        do {
            ...
            try await apiClient.likeProperty(id: property.id)
    ...
    private func dislikeProperty(_ property: Property) async {
        do {
            try await apiClient.dislikeProperty(id: property.id)
    ...
    private func checkForMatch(propertyId: UUID) async {
        ...
        do {
            let scoreResponse = try await apiClient.getMatchScore(propertyId: propertyId)
    ...
    private func loadMoreProperties() async {
        ...
        do {
            let moreProperties = try await apiClient.getMatches(filters: propertyFilters)
    ...
    private func calculateLocalScore(for property: Property) -> Int {
        ...
        if !filters.requiredAmenities.isEmpty {
            ...
            let matchedAmenities = filters.requiredAmenities.filter { propertyAmenityStrings.contains($0) }

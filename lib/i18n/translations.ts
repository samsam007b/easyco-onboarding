...
export const translations = {
  ...
  profileEnhance: {
    ...
    review: {
      title: {
        fr: 'Réviser votre profil',
        en: 'Review Your Profile',
        nl: 'Bekijk je profiel',
        de: 'Überprüfen Sie Ihr Profil',
      },
      description: {
        fr: 'Vérifiez toutes les informations avant de terminer',
        en: 'Check all information before completing',
        nl: 'Controleer alle informatie voordat je afrondt',
        de: 'Überprüfen Sie alle Informationen vor dem Abschluss',
      },
      loading: {
        fr: 'Chargement de votre profil...',
        en: 'Loading your profile...',
      ...
      sections: {
        about: { fr: 'À propos', en: 'About', nl: 'Over', de: 'Über' },
        hobbies: { fr: 'Hobbies', en: 'Hobbies', nl: 'Hobby\'s', de: 'Hobbys' },
        values: { fr: 'Valeurs', en: 'Values', nl: 'Waarden', de: 'Werte' },
        community: { fr: 'Communauté', en: 'Community', nl: 'Gemeenschap', de: 'Gemeinschaft' },

  ...
  return (
    <div className="bg-white px-3 py-2 rounded-lg shadow-lg border border-gray-100 text-sm">
      ...
      <p className="text-gray-600">
        <span className="font-semibold text-[#ee5736]">€{payload[0].value.toFixed(2)}</span>
      </p>
    </div>
  );
}
          ...
          <AreaChart data={data} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
            <defs>
              <linearGradient id="expenseGradient" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="#ee5736" stopOpacity={0.3} />
                <stop offset="100%" stopColor="#ee5736" stopOpacity={0.05} />
              </linearGradient>
            </defs>
        ...
        <AreaChart data={data} margin={{ top: 0, right: 0, left: 0, bottom: 0 }}>
          <defs>
            <linearGradient id="sparkGradient" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="#ee5736" stopOpacity={0.4} />
              <stop offset="100%" stopColor="#ee5736" stopOpacity={0.1} />
            </linearGradient>
          </defs>
          <Area
            type="monotone"

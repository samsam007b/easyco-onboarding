  ...
  return (
    <div className="space-y-4">
                  ...
                  <>
                    ...
                    <div className="flex items-center justify-between mb-1">
                      <span
                        className={cn(
                          'text-sm font-medium',
                          today ? 'text-[#e05747] font-bold' : 'text-gray-700',
                      ...
                      {today && (
                        <div className="w-2 h-2 rounded-full bg-[#e05747]" />
                      )}
                    </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <div className="bg-gray-50 superellipse-xl p-3 text-center">
          <p className="text-2xl font-bold text-[#e05747]">€{monthlyTotal.toFixed(0)}</p>

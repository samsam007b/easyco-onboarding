    ...
    <footer className="bg-gray-900 text-gray-300 py-12 mt-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          {/* Legal */}
          <div>
            <h4 className="text-white font-semibold mb-4">{footer.legal.title}</h4>
          ...
          {/* Platform */}
          <div>
            <h4 className="text-white font-semibold mb-4">{footer.platform.title}</h4>
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/onboarding/searcher" className="hover:text-white transition">
                  {footer.platform.findColiving}
                </Link>
              </li>
              <li>
                <Link href="/onboarding/owner" className="hover:text-white transition">
                  {footer.platform.listProperty}
                </Link>
              </li>
              <li>
                <Link href="/dashboard/searcher" className="hover:text-white transition">
                  {footer.platform.dashboard}
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="tel:+3222345678" className="hover:text-white transition">
                  +32 2 234 56 78
                </a>
              </li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              <a
                ...
                aria-label={ariaLabels?.facebook?.[language] || 'Facebook'}
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition"
                aria-label={ariaLabels?.instagram?.[language] || 'Instagram'}
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition"
                aria-label={ariaLabels?.linkedIn?.[language] || 'LinkedIn'}
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 pt-6 border-t border-gray-800">
          <div className="flex flex-wrap gap-4 justify-center text-xs text-gray-500">
            <div className="flex items-center gap-2">
              ...
              <span>{footer.trust.verified}</span>
            </div>
            <div className="flex items-center gap-2">
              <svg className="w-4 h-4 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
              </svg>
              <span>{footer.trust.gdpr}</span>
            </div>
            <div className="flex items-center gap-2">
              <svg className="w-4 h-4 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
              </svg>
              <span>{footer.trust.secure}</span>
            </div>
            <div className="flex items-center gap-2">
              <svg className="w-4 h-4 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>

            ...
            {Icon && (
              <motion.div
                ...
                className={`${sizes.iconContainer} mx-auto ${
                  variant === 'colorful'
                    ? 'bg-gradient-to-br from-[#9c5698]/10 via-[#e05747]/10 to-[#FFB10B]/10'
                    : 'bg-gray-100'
                } rounded-full flex items-center justify-center`}
              >
                <Icon className={`${sizes.icon} ${variant === 'colorful' ? 'text-[#e05747]' : 'text-gray-400'}`} />
              </motion.div>
            )}
          </div>
        </div>
          ...
          {primaryAction && (
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                ...
                className="bg-gradient-to-br from-[#9c5698] via-[#e05747] to-[#FFB10B] hover:opacity-90 text-white font-semibold px-6 py-3 superellipse-xl shadow-lg hover:shadow-xl transition-all"
              >

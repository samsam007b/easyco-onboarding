...
function OptimizedPropertyCard({
  property,
  residents = [],
          ...
          <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition-all overflow-hidden">
            ...
            <div className="relative h-40 bg-gray-200">
              ...
              <button
                ...
                className="absolute top-2 right-2 p-2 bg-white/90 backdrop-blur-sm rounded-full hover:scale-110 transition-transform z-10"
                ...
                <div className="relative z-20 flex items-center justify-between">
                  ...
                  {property.bedrooms && (
                    <span className="text-xs text-gray-500">
                      {property.bedrooms} {property.bedrooms > 1 ? 'ch.' : 'ch.'}
                    </span>
                  )}
                </div>
              </div>
...
export default memo(OptimizedPropertyCard);

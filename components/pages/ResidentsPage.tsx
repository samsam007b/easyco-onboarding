      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-orange-500 to-orange-600 mb-6 shadow-lg"
          >
          ...
          <Link href="/signup">
            <Button className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold px-8 py-3 rounded-full shadow-md hover:shadow-lg hover:scale-105 transition-all">
              ...
              {benefits.map((benefit, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="flex gap-4 p-6 rounded-xl hover:bg-orange-50 transition-all group"
                  >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {steps.map((step, index) => (
              ...
              >
                <div className="flex-shrink-0 w-12 h-12 rounded-full bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center text-white text-xl font-bold shadow-md">
                  {step.number}
                </div>
                <div>

...
import { ownerGradient, ownerGradientLight, ownerAnimations } from '@/lib/constants/owner-theme';
...
interface OwnerNavigationCardProps {
  title: string;
  description: string;
  icon: LucideIcon;
  href: string;
...
export function OwnerNavigationCard({
  title,
  description,
  icon: Icon,
  href,
...
// Grid wrapper
interface OwnerNavigationGridProps {
  children: React.ReactNode;
  className?: string;
}

export function OwnerNavigationGrid({ children, className }: OwnerNavigationGridProps) {
  return (

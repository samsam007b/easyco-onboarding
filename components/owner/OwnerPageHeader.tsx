...
import { ownerGradient, ownerAnimations } from '@/lib/constants/owner-theme';
        ...
        >
          ...
          {currentPage && (
            <>
              ...
              <span className="font-medium" style={{ color: '#9c5698' }}>
                {currentPage}
              </span>
            </>
          )}
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              ...
              <div
                ...
                style={{ background: ownerGradient, opacity: 0.3 }}
              />
              {/* Icon container */}
              <motion.div
                whileHover={{ rotate: 3 }}

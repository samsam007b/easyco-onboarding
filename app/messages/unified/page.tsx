...
function UnifiedMessagesContent() {
  ...
  const getVariant = (): 'searcher' | 'owner' | 'hub' => {
    switch (userRole) {
      case 'owner':
        return 'owner';
      case 'resident':
...
export default function UnifiedMessagesPage() {
  return (
    <Suspense
      fallback={
        <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-orange-50/30 via-white to-orange-50/30">
          <div className="text-center">
            <div className="flex justify-center mb-6">
              <LoadingHouse size={80} />
            </div>

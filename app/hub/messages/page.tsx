 ...
 * Hub Messages Page
 *
 * Unified messaging system for residents with Facebook Messenger-like experience.
 * Features:
 * - Pinned conversations (Ma Résidence, Mon Propriétaire)
 * - Role-based visual indicators
 * - Real-time messaging with typing indicators
 * - Invitation CTAs for missing owner/residents
 */
function HubMessagesContent() {
  ...
  const [invitationType, setInvitationType] = useState<'owner' | 'resident'>('owner');
  ...
  return (
    <div className="bg-gradient-to-br from-orange-50/30 via-white to-orange-50/30 px-4 sm:px-6 lg:px-8 pb-8">
      <MessagesLayout
        variant="hub"

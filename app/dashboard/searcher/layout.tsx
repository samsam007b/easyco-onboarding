...
export default function SearcherLayout({ children }: { children: React.ReactNode }) {
  ...
  if (!profile) return <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-white"><div className="text-center"><LoadingHouse size={80} /><p className="text-gray-600 font-medium">{t?.loading?.[language] || 'Loading...'}</p></div></div>;

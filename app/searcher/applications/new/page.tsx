      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-8">
          <Link href="/searcher/applications">
            <Button variant="ghost" className="gap-2 text-gray-600 hover:text-gray-900 hover:bg-blue-50 rounded-xl">
        ...
        <div className="text-center">
              ...
              {!subscribed ? (
                <form onSubmit={handleWaitlist} className="max-w-md mx-auto">
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    />
                    <button type="submit" className="bg-white px-8 py-4 rounded-xl font-bold text-blue-500">
                      M'inscrire
                    </button>
                  </div>
                </form>
          ...
          <motion.div variants={itemVariants} className="bg-white rounded-2xl p-6" style={{ boxShadow: '0 4px 20px rgba(0, 0, 0, 0.06)' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Button onClick={() => router.push('/profile/enhance')} variant="outline" className="rounded-xl px-6 py-5 border-gray-200">

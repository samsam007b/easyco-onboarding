          ...
          >
            <Card className="p-8 text-center bg-white superellipse-3xl shadow-2xl border-0">
              ...
              <p className="text-gray-600 mb-6">
                ...
                {matching.gate?.requirement || 'Complete your profile to at least'} <span className="font-bold text-orange-600">70%</span> {matching.gate?.toUnlock || 'to unlock matching'}.
              </p>
